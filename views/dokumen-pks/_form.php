...
<div class="dokumen-pks-form">
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-10 ">
            <?= $form->field($model,'jenis_pks', ['options' => ['class' => 'mb-0']])->label(false)->textInput(['class'=>'form-control', 'maxlength' => 30, 'autocomplete'=>"off"]) ?>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-10 ">
            <?= $form->field($model,'tgl_berakhir_pks', ['options' => ['class' => 'mb-0']])->label(false)->textInput(['class'=>'form-control', 'maxlength' => 30, 'autocomplete'=>"off"]) ?>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-10 ">
            <?= $form->field($model,'status_pks', ['options' => ['class' => 'mb-0']])->label(false)->textInput(['class'=>'form-control', 'maxlength' => 30, 'autocomplete'=>"off"]) ?>
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-10 ">
            <?= $form->field($model,'bagian_pks', ['options' => ['class' => 'mb-0']])->label(false)->textInput(['class'=>'form-control', 'maxlength' => 30, 'autocomplete'=>"off"]) ?>
        </div>
    </div>
